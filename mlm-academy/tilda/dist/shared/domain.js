...
(function (root) {
  ...
  var ACCENT_INK = { A1: '#ffffff', A2: '#111111', A3: '#111111', A4: '#111111', A5: '#111111', A6: '#111111' };
  var SECTION_COLORS = {
    A1: '#3157ff',
    A2: '#d5ff43',
    A3: '#ff6b35',
  ...
  function getTrackStatusView(track, options) {
    ...
    if (availability === 'published_empty') {
      return {
        ...
        canStart: false,
        showProgress: false,
        explanation: 'Карточка опубликована, но шаги ещё не добавлены. Кнопка действия появится вместе с ними.',
      };
    }
  ...
  function isListed(track, preview) {
    ...
    if (preview) return track.publicationStatus !== 'archived';
  ...
  function accentStyle(sectionId) {
    return {
      '--mlma-accent': SECTION_COLORS[sectionId] || '#d5ff43',
      '--mlma-accent-ink': ACCENT_INK[sectionId] || '#111111',
    };
  }

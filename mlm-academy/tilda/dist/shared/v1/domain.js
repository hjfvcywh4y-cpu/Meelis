...
(function (root) {
  ...
  var INTENTS = [
    ...
    },
    {
      ...
      reason: 'Подходит, потому что вам нужно понять, с кем начать.',
    },
    {
      id: 'ethics',
    ...
    },
    {
      ...
      reason: 'Подходит, потому что вы хотите получить первый рабочий результат.',
    },
    {
      id: 'just-started',
    ...
    },
    {
      ...
      boostIds: ['A6-001', 'A6-002', 'A6-003'],
      reason: 'Подходит, потому что клиент недоволен, и нужно разобрать опыт.',
    },
    {
      id: 'team',
      ...
      teamOnly: true,
      reason: 'Подходит, потому что это задача про команду и наставничество.',
    },
    {
      id: 'price',
      goal: 'разобрать ценовое возражение',
    ...
    },
    {
      ...
      reason: 'Подходит, потому что нужно честно рассказать о продукте на языке человека.',
    },
    {
      id: 'silent-message',
    ...
    },
    {
      ...
      reason: 'Подходит, потому что речь о повторном контакте после покупки.',
    },
  ];
  ...
  var ADJACENT_SCOPE = [
    ...
    },
    {
      ...
      matchType: 'adjacent',
      reason: 'Ближайший полезный шаг — начать разговор или честно рассказать о продукте.',
    },
  ];
...
(function (root) {
  ...
  function qualityCheck(track, payload) {
    ...
    var gaps = [];
    if (artifact.length < 40) gaps.push('Результат слишком короткий: опишите конкретный рабочий объект.');
  ...
  function buildFeedback(track, check) {
    ...
    return {
      ...
      now: check.high ? 'Можно перейти к следующему действию без дополнительного закрепления.' : 'Дальше — следующее лучшее действие.',
      retry: false,
    };
  }

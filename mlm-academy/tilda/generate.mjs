...
const SPLIT = '\n\n/* __MLMA_UI_SPLIT__ */\n\n';
const domainJs = [domainCore.trim(), accessJs.trim(), storageJs.trim(), paymentsJs.trim(), commerceJs.trim(), legalJs.trim(), searchJs.trim(), analyticsJs.trim(), packageRuntimeJs.trim(), packageBindJs.trim()].join(SPLIT) + '\n\n' + ontologyJs.trim();

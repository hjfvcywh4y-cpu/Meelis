...
function seoHead(page, opts = {}) {
  const map = {
    ...
    privacy: 'Политика конфиденциальности MLM Academy: оператор, цели, состав данных, обработчики, сроки и права пользователя.',
    consent: 'Согласие на обработку и передачу персональных данных при регистрации бесплатного кабинета MLM Academy.',
    offer: 'Публичная оферта MLM Academy на использование бесплатного кабинета и публичных материалов.',
    requisites: 'Реквизиты исполнителя MLM Academy: ИП Борисенко Татьяна Анатольевна.',
...
При регистрации показывать обязательное согласие со ссылкой на \`/consent\` и \`/privacy\`.

...
ABOUT_US_TEXT = (
    ...
    "Мы строим не просто ещё одну MLM-компанию.\n"
    ...
    "Для нас принципиально не просто выпускать продукт быстрее. "
    "<b>Качество важнее гонки за сроками:</b> компания публично переносила "
    "поставки, когда ускорение могло повлиять на качество.\n\n"

...
# 5 мм ≈ 59 px при scale шаблона; тексты опущены на эту величину.
# QR — квадрат по центру внутренней области рамки.
NAME_XY = (800, 419)
TITLE_XY = (800, 479)
TG_XY = (800, 559)
PHONE_XY = (800, 619)
TEXT_MAX_X = 1090  # не заходить в зону QR
QR_BOX = (1133, 380, 1327, 574)  # квадрат по центру рамки QR
